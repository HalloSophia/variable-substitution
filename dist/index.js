...
function detectFileEncodingWithBOM(fileName, buffer) {
    ...
    if (buffer.subarray(0, 3).equals(Buffer.from([239, 187, 191]))) {
        return {
            encoding: 'utf-8',
            withBOM: true
        };
    }
    else if (buffer.subarray(0, 4).equals(Buffer.from([255, 254, 0, 0]))) {
    ...
    else if (buffer.subarray(0, 2).equals(Buffer.from([254, 255]))) {
    ...
    else if (buffer.subarray(0, 2).equals(Buffer.from([255, 254]))) {
        return {
            encoding: 'utf16le',
            withBOM: true
        };
    }
    else if (buffer.subarray(0, 4).equals(Buffer.from([0, 0, 254, 255]))) {
        throw Error(`Detected file encoding of the file ${fileName} as UTF-32BE. Variable substitution is not supported with file encoding UTF-32BE. Supported encodings are UTF-8 and UTF-16LE.`);
    }
...
const core = __nccwpck_require__(2186);
const envVariableUtility_1 = __nccwpck_require__(2191);
...
var envVarUtility = __nccwpck_require__(2191);
var ltx = __nccwpck_require__(8719);
class XmlDomUtility {
...
const core = __nccwpck_require__(2186);
let envVarUtility = __nccwpck_require__(2191);
...
const core = __nccwpck_require__(2186);
const envVariableUtility_1 = __nccwpck_require__(2191);
const jsonVariableSubstitutionUtility_1 = __nccwpck_require__(6889);
const xmlDomUtility_1 = __nccwpck_require__(7575);
const xmlVariableSubstitution_1 = __nccwpck_require__(7700);
const utility_1 = __nccwpck_require__(1753);
const fs = __nccwpck_require__(7147);
const yaml = __nccwpck_require__(1917);
const fileEncoding = __nccwpck_require__(5143);
            ...
            for (let file of matchedFiles) {
                ...
                if (this.isJson(file, fileContent)) {
                    ...
                    if (isYamlSubstitutionApplied) {
                        fs.writeFileSync(file, (fileEncodeType.withBOM ? '\uFEFF' : '') + yaml.dump(yamlObject), { encoding: fileEncodeType.encoding });
...
var _escape = __nccwpck_require__(1364);
...
var events = __nccwpck_require__(2361);
var Element = __nccwpck_require__(5206);
var ltx = __nccwpck_require__(3099);
...
var parse = __nccwpck_require__(5077);
var Parser = __nccwpck_require__(2851);
var _escape = __nccwpck_require__(1364);
var Element = __nccwpck_require__(5206);
var equal = __nccwpck_require__(1453);
var createElement = __nccwpck_require__(6996);
var tag = __nccwpck_require__(3146);
var tagString = __nccwpck_require__(2697);
var is = __nccwpck_require__(8025);
var clone = __nccwpck_require__(7649);
var stringify = __nccwpck_require__(5842);
var JSONify = __nccwpck_require__(5510);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(9340);
